import{p as e,N as w,G as c,u as j,a as b,r as d,j as t,h as M,O as y}from"./index-CRPR428z.js";const k=e.ul`
  display: flex;
...
`,E=({darkTheme:n,toggleTheme:a})=>t.jsx("div",{children:t.jsx(W,{darkTheme:n,onClick:a,children:n?t.jsx(O,{}):t.jsx(I,{})})}),A=e.nav`
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`,T=({menuOpen:n})=>t.jsxs($,{children:[t.jsx(R,{onClick:n,children:t.jsx(G,{})}),t.jsx(D,{})]}),q=e.div`
...
`,K=()=>{const[n,a]=d.useState(!1),[i,r]=d.useState(!0),h=()=>{r(!i)},s=()=>{a(!n)};return t.jsxs(q,{darkTheme:i,children:[t.jsx(F,{toggleTheme:h,isMenuOpen:n,menuClose:s,darkTheme:i}),t.jsxs(J,{children:[t.jsx(T,{menuOpen:s}),t.jsx(N,{}),t.jsx(y,{context:{darkTheme:i}})]})]})};export{K as default};
